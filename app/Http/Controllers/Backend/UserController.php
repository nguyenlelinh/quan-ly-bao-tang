...
use App\Repositories\Interfaces\UserCatalogueRepositoryInterface as UserCatalogRepository;
...
class UserController extends Controller
{
    ...
    public function __construct(
        UserCatalogRepository $userCatalogueRepository,
        UserService $userService,
        ProvinceRepository $provinceRepository,
        UserRepository $userRepository,
    ){
        $this->usercatalogrepository = $userCatalogueRepository;
...
//        dd($request);
    ...
    public function create(){
        ...
        $usercatalog = $this->usercatalogrepository->all();
